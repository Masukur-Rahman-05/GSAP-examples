...
function DirUseGSAP() {
  ...
  // useGSAP automatically cleans up animations and runs on state changes
  useGSAP(() => {
  ...
  }, { dependencies: [axis, rotate] }); // Animation re-runs when axis or rotate changes
